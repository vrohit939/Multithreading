...
class Task1 implements Runnable {
    ...
    @Override
    public void run() {
        synchronized (paper) { // To avoid deadlock thread1 needs to make sure to first acquire lock for paper before calling pen method
...
class Task2 implements Runnable {
    ...
    @Override
    public void run() {
        synchronized (pen) { // To avoid deadlock thread1 needs to make sure to first acquire lock for pen before calling paper method
...
public class DeadLockExample {
    ...
    public static void main(String[] args) {
        ...
        Thread t2 = new Thread(new Task1(pen, paper), "Thread-2");
